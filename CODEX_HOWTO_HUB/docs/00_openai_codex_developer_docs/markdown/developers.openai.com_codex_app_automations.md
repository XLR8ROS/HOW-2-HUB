# developers.openai.com_codex_app_automations
...
# Automations 
 ...
 Copy Page Automate recurring tasks in the background. Codex adds findings to the inbox, or automatically archives the task if there’s nothing to report. You can combine automations with skills for more complex tasks.
