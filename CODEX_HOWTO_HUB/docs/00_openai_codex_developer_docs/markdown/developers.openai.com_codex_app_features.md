# developers.openai.com_codex_app_features
...
# Codex app features 
 ...
 Copy Page The Codex app is a focused desktop experience for working on Codex threads in parallel,
...
## Computer use 
 Computer use helps Codex operate a macOS app by
