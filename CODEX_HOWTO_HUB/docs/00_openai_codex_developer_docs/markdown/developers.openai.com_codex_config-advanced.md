# developers.openai.com_codex_config-advanced
...
# Advanced Configuration 
 ...
 Copy Page Use these options when you need more control over providers, policies, and integrations. For a quick start, see Config basics .
...
constraints, see Configuration Reference and
 Managed configuration .
