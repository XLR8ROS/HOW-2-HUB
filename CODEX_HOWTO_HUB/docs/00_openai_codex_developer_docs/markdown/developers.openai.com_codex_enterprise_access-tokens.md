# developers.openai.com_codex_enterprise_access-tokens
...
# Access tokens 
 Create and manage Codex access tokens for programmatic workflows

 Copy Page Codex access tokens let trusted automation run Codex local with a ChatGPT workspace identity. Use them when a script, scheduled job, or CI runner needs repeatable, non-interactive Codex access.
