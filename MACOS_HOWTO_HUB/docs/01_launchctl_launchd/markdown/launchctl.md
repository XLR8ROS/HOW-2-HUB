...
SSUUBBCCOOMMMMAANNDDSS
     llaauunncchhccttll allows for detailed examination of llaauunncchhdd's data structures.
...
SSUUBBCCOOMMMMAANNDDSS
     ...
     _d_e_b_u_g _s_e_r_v_i_c_e_-_t_a_r_g_e_t [_-_-_p_r_o_g_r_a_m _<_p_r_o_g_r_a_m _p_a_t_h_>] [_-_-_g_u_a_r_d_-_m_a_l_l_o_c]
              ...
              _-_-_3_2     Runs the service in the appropriate 32-bit
              ...
              _-_-_s_t_d_i_n _[_s_t_d_i_n_-_p_a_t_h_]
                       ...
                       service's standard input. If _s_t_d_i_n_-_p_a_t_h does not exist,
                       it is created.

              _-_-_s_t_d_o_u_t _[_s_t_d_o_u_t_-_p_a_t_h_]
                       Sets the service's standard output to be _s_t_d_o_u_t_-_p_a_t_h.
                       If no file is given, uses the current terminal as the
                       service's standard output. If _s_t_d_o_u_t_-_p_a_t_h does not
                       exist, it is created.

              _-_-_s_t_d_e_r_r _[_s_t_d_e_r_r_-_p_a_t_h_]
                       Sets the service's standard error to be _s_t_d_e_r_r_-_p_a_t_h.
                       If no file is given, uses the current terminal as the
                       service's standard error. If _s_t_d_e_r_r_-_p_a_t_h does not
                       exist, it is created.
              ...
              _-_- _a_r_g_v_0 _a_r_g_v_1 _._._.
                       ...
                       vector. As with the _P_r_o_g_r_a_m_A_r_g_u_m_e_n_t_s launchd.plist(5)
     ...
     _p_r_o_c_i_n_f_o _p_i_d
              ...
              namespace, if they are known to llaauunncchhdd) and audit session
     ...
     _e_x_a_m_i_n_e [_t_o_o_l _a_r_g_0 _a_r_g_1 _@_P_I_D _._._.]
              ...
              an effective snapshot of llaauunncchhdd that can be examined
              ...
              instead specify the argument "@PID", and llaauunncchhccttll will
     ...
     _c_o_n_f_i_g _s_y_s_t_e_m | _u_s_e_r _p_a_r_a_m_e_t_e_r _v_a_l_u_e
              ...
              implementation detail, and changes to that storage should _o_n_l_y
              ...
              path     Sets the PATH environment variable for all services
                       ...
                       _N_O_T_E: This facility cannot be used to set general
     ...
     _r_e_b_o_o_t _[_s_y_s_t_e_m_|_u_s_e_r_s_p_a_c_e_|_h_a_l_t_|_l_o_g_o_u_t_|_a_p_p_s_]
              Instructs llaauunncchhdd to begin tearing down userspace. With no
              argument given or with the _s_y_s_t_e_m argument given, llaauunncchhdd will
              make the reboot(2) system call when userspace has been
              completely torn down. With the _h_a_l_t argument given, llaauunncchhdd will
              make the reboot(2) system call when userspace has been
              completely torn down and pass the _R_B___H_A_L_T flag, halting the
              ...
              same manner as the _l_o_g_o_u_t argument, and all the same caveats
              apply.
     ...
     _v_a_r_i_a_n_t  Prints the llaauunncchhdd variant currently active on the system.
...
LLEEGGAACCYY SSUUBBCCOOMMMMAANNDDSS
     ...
     _l_o_a_d | _u_n_l_o_a_d [--wwFF] [--SS _s_e_s_s_i_o_n_t_y_p_e] [--DD _s_e_a_r_c_h_p_a_t_h] _p_a_t_h_s _._._.
              Recommended alternative subcommands: _b_o_o_t_s_t_r_a_p | _b_o_o_t_o_u_t |
              _e_n_a_b_l_e | _d_i_s_a_b_l_e
              ...
              they are located in //LLiibbrraarryy//LLaauunncchhAAggeennttss) or the user loading
              them (if they are located in $$HHOOMMEE//LLiibbrraarryy//LLaauunncchhAAggeennttss).  All
              ...
              --SS _s_e_s_s_i_o_n_t_y_p_e
                       ...
                       flag instructs llaauunncchhccttll to look for jobs in a
              ...
              _N_O_T_E: Due to bugs in the previous implementation and long-
              standing client expectations around those bugs, the _l_o_a_d and
              _u_n_l_o_a_d subcommands will only return a non-zero exit code due to
     ...
     _l_i_s_t [_-_x] [_l_a_b_e_l]
              Recommended alternative subcommand: _p_r_i_n_t
              ...
              SIGTERM.  The third column is the job's label. If [_l_a_b_e_l] is
     ...
     _s_e_t_e_n_v _k_e_y _v_a_l_u_e
              ...
              processes launched by llaauunncchhdd in the caller's context.
     ...
     _g_e_t_r_u_s_a_g_e _s_e_l_f | _c_h_i_l_d_r_e_n
              Get the resource utilization statistics for llaauunncchhdd or the
              children of llaauunncchhdd.  This subcommand is not implemented.
     ...
     _m_a_n_a_g_e_r_p_i_d
              ...
              llaauunncchhdd processes each managing their own Mach bootstrap
...
DDEEPPRREECCAATTEEDD AANNDD RREEMMOOVVEEDD FFUUNNCCTTIIOONNAALLIITTYY
     ...
     from stdin. The //eettcc//llaauunncchhdd..ccoonnff file is no longer consulted for
     ...
     $$HHOOMMEE//..llaauunncchhdd..ccoonnff would be consulted prior to setting up a user's
...
FFIILLEESS
     ...
     _/_L_i_b_r_a_r_y_/_L_a_u_n_c_h_D_a_e_m_o_n_s         System wide daemons provided by the
                                    administrator.
     _/_S_y_s_t_e_m_/_L_i_b_r_a_r_y_/_L_a_u_n_c_h_A_g_e_n_t_s   OS X Per-user agents.
     _/_S_y_s_t_e_m_/_L_i_b_r_a_r_y_/_L_a_u_n_c_h_D_a_e_m_o_n_s  OS X System wide daemons.
