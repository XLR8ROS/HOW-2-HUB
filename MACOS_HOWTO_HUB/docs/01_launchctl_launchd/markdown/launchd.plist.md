...
NNAAMMEE
     llaauunncchhdd..pplliisstt – System wide and per-user daemon/agent configuration files

DDEESSCCRRIIPPTTIIOONN
     This document details the parameters that can be given to an XML property
     list that can be loaded into llaauunncchhdd with llaauunncchhccttll.

EEXXPPEECCTTAATTIIOONNSS
     Daemons or agents managed by llaauunncchhdd are expected to behave certain ways.

     A daemon or agent launched by llaauunncchhdd MUST NOT do the following in the
     process directly launched by llaauunncchhdd:

           ••   Call daemon(3).
           ••   Do the moral equivalent of daemon(3) by calling fork(2) and
               have the parent process exit(3) or _exit(2).

     A llaauunncchhdd daemon or agent should not perform the following as part of its
     initialization, as launchd will always implicitly perform them on behalf
     of the process.

           ••   Redirect stdio(3) to /dev/null.

     A llaauunncchhdd daemon or agent need not perform the following as part of its
     initialization, since llaauunncchhdd can perform them on the process' behalf
     with the appropriate llaauunncchhdd..pplliisstt keys specified.
     ...
     A daemon or agent launched by llaauunncchhdd SHOULD:
     ...
     A daemon or agent launched by llaauunncchhdd _M_U_S_T:

           ••   check in for any MMaacchhSSeerrvviicceess advertised in its plist, using
               xpc_connection_create_mach_service(3) (or
               bootstrap_check_in(3)) if it uses MIG or raw Mach for
               communication
           ••   check in for any LLaauunncchhEEvveennttss advertised in its plist, using
               xpc_set_event_stream_handler(3)

XXMMLL PPRROOPPEERRTTYY LLIISSTT KKEEYYSS
     ...
     LLaabbeell <<ssttrriinngg>>
     This required key uniquely identifies the job to llaauunncchhdd.

     DDiissaabblleedd <<bboooolleeaann>>
     This optional key specifies whether the job should be loaded by default.
     Note that this key may be overridden through the _e_n_a_b_l_e subcommand of
     ...
     UUsseerrNNaammee <<ssttrriinngg>>
     ...
     GGrroouuppNNaammee <<ssttrriinngg>>
     ...
     iinneettddCCoommppaattiibbiilliittyy <<ddiiccttiioonnaarryy>>
     ...
     avoided.
           ...
           WWaaiitt <<bboooolleeaann>>
     ...
     LLiimmiittLLooaaddTTooHHoossttss <<aarrrraayy ooff ssttrriinnggss>>
     This configuration file only applies to the hosts listed with this key.
     This key is no longer supported.

     LLiimmiittLLooaaddFFrroommHHoossttss <<aarrrraayy ooff ssttrriinnggss>>
     This configuration file only applies to hosts NOT listed with this key.
     This key is no longer supported.

     LLiimmiittLLooaaddTTooSSeessssiioonnTTyyppee <<ssttrriinngg oorr aarrrraayy ooff ssttrriinnggss>>
     ...
     LLiimmiittLLooaaddTTooHHaarrddwwaarree <<ddiiccttiioonnaarryy ooff aarrrraayyss>>
     ...
     LLiimmiittLLooaaddFFrroommHHaarrddwwaarree <<ddiiccttiioonnaarryy ooff aarrrraayyss>>
     ...
     PPrrooggrraamm <<ssttrriinngg>>
     ...
     PPrrooggrraammAArrgguummeennttss will be used instead. This key is required in the
     absence of the PPrrooggrraammAArrgguummeennttss and BBuunnddlleePPrrooggrraamm keys.

     BBuunnddlleePPrrooggrraamm <<ssttrriinngg>>
     ...
     PPrrooggrraammAArrgguummeennttss <<aarrrraayy ooff ssttrriinnggss>>
     ...
     key is required in the absence of the Program key.  _I_M_P_O_R_T_A_N_T_: Many
     people are confused by this key. Please read execvp(3) very carefully!

     _N_O_T_E_: The PPrrooggrraamm key must be an absolute path. Previous versions of
     launchd did not enforce this requirement but failed to run the job. In
     the absence of the PPrrooggrraamm key, the first element of the PPrrooggrraammAArrgguummeennttss
     array may be either an absolute path, or a relative path which is
     resolved using _PATH_STDPATH.

     EEnnaabblleeGGlloobbbbiinngg <<bboooolleeaann>>
     This flag causes llaauunncchhdd to use the glob(3) mechanism to update the
     program arguments before invocation.

     EEnnaabblleeTTrraannssaaccttiioonnss <<bboooolleeaann>>
     This key instructs llaauunncchhdd that the job uses xpc_transaction_begin(3) and
     ...
     message is discarded. When llaauunncchhdd stops an active process, it sends
     SIGTERM first, and then SIGKILL after a reasonable timeout. If the
     process is inactive, SIGKILL is sent immediately.

     EEnnaabblleePPrreessssuurreeddEExxiitt <<bboooolleeaann>>
     This key opts the job into the system's Pressured Exit facility. Use of
     this key implies EEnnaabblleeTTrraannssaaccttiioonnss , and also lets the system consider
     ...
     _N_O_T_E: launchd(8) does not respect EEnnaabblleePPrreessssuurreeddEExxiitt for jobs that have
     KKeeeeppAAlliivvee set to true.

     _I_M_P_O_R_T_A_N_T: Jobs which opt into Pressured Exit will ignore SIGTERM rather
     than exiting by default, so a dispatch(3) source must be used when
     handling this signal.

     OOnnDDeemmaanndd <<bboooolleeaann>>
     This key does nothing if set to true. If set to false, this key is
     equivalent to specifying a true value for the KKeeeeppAAlliivvee key. This key
     should not be used. Please remove this key from your llaauunncchhdd..pplliisstt.

     SSeerrvviicceeIIPPCC <<bboooolleeaann>>
     Please remove this key from your llaauunncchhdd..pplliisstt.

     KKeeeeppAAlliivvee <<bboooolleeaann oorr ddiiccttiioonnaarryy ooff ssttuuffff>>
     ...
     control whether llaauunncchhdd keeps a job alive or not. If multiple keys are
     provided, launchd ORs them, thus providing maximum flexibility to the job
     to refine the logic and stall if necessary. If llaauunncchhdd finds no reason to
     ...
     implies RunAtLoad, causing llaauunncchhdd to speculatively launch the job.

           SSuucccceessssffuullEExxiitt <<bboooolleeaann>>
           ...
           NNeettwwoorrkkSSttaattee <<bboooolleeaann>>
           This key is no longer implemented as it never acted how most users
           expected.

           PPaatthhSSttaattee <<ddiiccttiioonnaarryy ooff bboooolleeaannss>>
           ...
           example keeps the job alive as long as the file //ppaatthh//ttoo//ffiillee
           exists.
           ...
           _I_M_P_O_R_T_A_N_T: Filesystem monitoring mechanisms are inherently race-
           prone and lossy. This option should be avoided in favor of demand-
           based alternatives using IPC.

           OOtthheerrJJoobbEEnnaabblleedd <<ddiiccttiioonnaarryy ooff bboooolleeaannss>>
           ...
           _N_O_T_E: This key only evaluates whether the job is loaded, not
           ...
           CCrraasshheedd <<bboooolleeaann>>
     ...
     RRuunnAAttLLooaadd <<bboooolleeaann>>
     ...
     RRoooottDDiirreeccttoorryy <<ssttrriinngg>>
     This optional key is used to specify a directory to chroot(2) to before
     running the job.

     _I_M_P_O_R_T_A_N_T: iOS and OS X both make significant use of IPC to implement
     ...
     WWoorrkkiinnggDDiirreeccttoorryy <<ssttrriinngg>>
     This optional key is used to specify a directory to chdir(2) to before
     running the job.

     EEnnvviirroonnmmeennttVVaarriiaabblleess <<ddiiccttiioonnaarryy ooff ssttrriinnggss>>
     ...
     representing the desired value.  _N_O_T_E: Values other than strings will be
     ignored.

     UUmmaasskk <<iinntteeggeerr oorr ssttrriinngg>>
     ...
     TTiimmeeOOuutt <<iinntteeggeerr>>
     ...
     EExxiittTTiimmeeOOuutt <<iinntteeggeerr>>
     The amount of time llaauunncchhdd waits between sending the SIGTERM signal and
     ...
     TThhrroottttlleeIInntteerrvvaall <<iinntteeggeerr>>
     This key lets one override the default throttling policy imposed on jobs
     by llaauunncchhdd.  The value is in seconds, and by default, jobs will not be
     ...
     IInniittGGrroouuppss <<bboooolleeaann>>
     ...
     UUsseerrNNaammee key is not set. Note that for agents, the UUsseerrNNaammee key is
     ignored.

     WWaattcchhPPaatthhss <<aarrrraayy ooff ssttrriinnggss>>
     This optional key causes the job to be started if any one of the listed
     paths are modified.

     _I_M_P_O_R_T_A_N_T: Use of this key is highly discouraged, as filesystem event
     ...
     QQuueeuueeDDiirreeccttoorriieess <<aarrrraayy ooff ssttrriinnggss>>
     This optional key keeps the job alive as long as the directory or
     directories specified are not empty.

     SSttaarrttOOnnMMoouunntt <<bboooolleeaann>>
     This optional key causes the job to be started every time a filesystem is
     mounted.

     SSttaarrttIInntteerrvvaall <<iinntteeggeerr>>
     ...
     SSttaarrttCCaalleennddaarrIInntteerrvvaall <<ddiiccttiioonnaarryy ooff iinntteeggeerrss oorr aarrrraayy ooff ddiiccttiioonnaarriieess ooff
     ...
     Note that SSttaarrttIInntteerrvvaall and SSttaarrttCCaalleennddaarrIInntteerrvvaall are not aware of each
     other. They are evaluated completely independently by the system.

           MMiinnuuttee <<iinntteeggeerr>>
           The minute (0-59) on which this job will be run.

           HHoouurr <<iinntteeggeerr>>
           The hour (0-23) on which this job will be run.

           DDaayy <<iinntteeggeerr>>
           The day of the month (1-31) on which this job will be run.

           WWeeeekkddaayy <<iinntteeggeerr>>
           The weekday on which this job will be run (0 and 7 are Sunday). If
           both DDaayy and WWeeeekkddaayy are specificed, then the job will be started
           if either one matches the current date.

           MMoonntthh <<iinntteeggeerr>>
           The month (1-12) on which this job will be run.

     SSttaannddaarrddIInnPPaatthh <<ssttrriinngg>>
     ...
     SSttaannddaarrddOOuuttPPaatthh <<ssttrriinngg>>
     This optional key specifies that the given path should be mapped to the
     ...
     specified as the UUsseerrNNaammee and/or GGrroouuppNNaammee, respectively (if set) and
     permissions reflecting the umask(2) specified by the UUmmaasskk key, if set.

     SSttaannddaarrddEErrrroorrPPaatthh <<ssttrriinngg>>
     This optional key specifies that the given path should be mapped to the
     ...
     and/or group specified as the UUsseerrNNaammee and/or GGrroouuppNNaammee, respectively (if
     set) and permissions reflecting the umask(2) specified by the UUmmaasskk key,
     if set.

     DDeebbuugg <<bboooolleeaann>>
     This optional key specifies that llaauunncchhdd should adjust its log mask
     temporarily to LOG_DEBUG while dealing with this job.

     WWaaiittFFoorrDDeebbuuggggeerr <<bboooolleeaann>>
     This optional key specifies that llaauunncchhdd should launch the job in a
     suspended state so that a debugger can be attached to the process as
     early as possible (at the first instruction).

     SSooffttRReessoouurrcceeLLiimmiittss <<ddiiccttiioonnaarryy ooff iinntteeggeerrss>>

     HHaarrddRReessoouurrcceeLLiimmiittss <<ddiiccttiioonnaarryy ooff iinntteeggeerrss>>
     Resource limits to be imposed on the job. These adjust variables set with
     setrlimit(2).  The following keys apply:

           CCoorree <<iinntteeggeerr>>
           The largest size (in bytes) core file that may be created.

           CCPPUU <<iinntteeggeerr>>
           ...
           FFiilleeSSiizzee <<iinntteeggeerr>>
           The largest size (in bytes) file that may be created.

           MMeemmoorryyLLoocckk <<iinntteeggeerr>>
           The maximum size (in bytes) which a process may lock into memory
           using the mlock(2) function.

           NNuummbbeerrOOffFFiilleess <<iinntteeggeerr>>
           ...
           NNuummbbeerrOOffPPrroocceesssseess <<iinntteeggeerr>>
           ...
           RReessiiddeennttSSeettSSiizzee <<iinntteeggeerr>>
           ...
           SSttaacckk <<iinntteeggeerr>>
           The maximum size (in bytes) of the stack segment for a process;
           this defines how far a program's stack segment may be extended.
           Stack extension is performed automatically by the system.

     NNiiccee <<iinntteeggeerr>>
     This optional key specifies what nice(3) value should be applied to the
     daemon.

     PPrroocceessssTTyyppee <<ssttrriinngg>>
     ...
     AAbbaannddoonnPPrroocceessssGGrroouupp <<bboooolleeaann>>
     When a job dies, llaauunncchhdd kills any remaining processes with the same
     process group ID as the job. Setting this key to true disables that
     behavior.

     LLoowwPPrriioorriittyyIIOO <<bboooolleeaann>>
     This optional key specifies whether the kernel should consider this
     daemon to be low priority when doing filesystem I/O.

     LLoowwPPrriioorriittyyBBaacckkggrroouunnddIIOO <<bboooolleeaann>>
     This optional key specifies whether the kernel should consider this
     ...
     MMaatteerriiaalliizzeeDDaattaalleessssFFiilleess
     ...
     LLaauunncchhOOnnllyyOOnnccee <<bboooolleeaann>>
     ...
     MMaacchhSSeerrvviicceess <<ddiiccttiioonnaarryy ooff bboooolleeaannss oorr aa ddiiccttiioonnaarryy ooff ddiiccttiioonnaarriieess>>
     ...
     advertised. Valid keys in this dictionary are:
           ...
           RReesseettAAttCClloossee <<bboooolleeaann>>
           ...
           HHiiddeeUUnnttiillCChheecckkIInn <<bboooolleeaann>>
           Reserve the name in the namespace, but cause bootstrap_look_up() to
           fail until the job has checked in with llaauunncchhdd.
     ...
     SSoocckkeettss <<ddiiccttiioonnaarryy ooff ddiiccttiioonnaarriieess...... OORR ddiiccttiioonnaarryy ooff aarrrraayy ooff
     ddiiccttiioonnaarriieess......>>
     This optional key is used to specify launch on demand sockets that can be
     used to let llaauunncchhdd know when to run the job. The job must check-in to
     ...
     The parameters below are used as inputs to call getaddrinfo(3).
           ...
           SSoocckkTTyyppee <<ssttrriinngg>>
           This optional key tells llaauunncchhdd what type of socket to create. The
           default is "stream" and other valid values for this key are "dgram"
           and "seqpacket" respectively.

           SSoocckkPPaassssiivvee <<bboooolleeaann>>
           ...
           SSoocckkNNooddeeNNaammee <<ssttrriinngg>>
           This optional key specifies the node to connect(2) or bind(2) to.

           SSoocckkSSeerrvviicceeNNaammee <<ssttrriinngg oorr iinntteeggeerr>>
           ...
           SSoocckkFFaammiillyy <<ssttrriinngg>>
           ...
           SSoocckkPPrroottooccooll <<ssttrriinngg>>
           ...
           SSoocckkPPaatthhNNaammee <<ssttrriinngg>>
           This optional key implies SockFamily is set to "Unix". It specifies
           the path to connect(2) or bind(2) to.

           SSeeccuurreeSSoocckkeettWWiitthhKKeeyy <<ssttrriinngg>>
           ...
           SSoocckkPPaatthhOOwwnneerr <<iinntteeggeerr>>
           This optional key specifies the user ID that should be the domain
           socket's owner.

           SSoocckkPPaatthhGGrroouupp <<iinntteeggeerr>>
           This optional key specifies the group ID that should be set as the
           domain socket's group.

           SSoocckkPPaatthhMMooddee <<iinntteeggeerr>>
           ...
           BBoonnjjoouurr <<bboooolleeaann oorr ssttrriinngg oorr aarrrraayy ooff ssttrriinnggss>>
           ...
           MMuullttiiccaassttGGrroouupp <<ssttrriinngg>>
     ...
     LLaauunncchhEEvveennttss <<ddiiccttiioonnaarryy ooff ddiiccttiioonnaarriieess ooff ddiiccttiioonnaarriieess>>
     ...
     HHooppeeffuullllyyEExxiittssLLaasstt <<ssttrriinngg>>
     This key was a hack for jobs which could not properly keep track of their
     clients and is no longer implemented.

     HHooppeeffuullllyyEExxiittssFFiirrsstt <<ssttrriinngg>>
     This key was a hack for jobs which could not properly keep track of their
     clients and is no longer implemented.

     SSeessssiioonnCCrreeaattee <<bboooolleeaann>>
     This key specifies that the job should be spawned into a new security
     audit session rather than the default session for the context is belongs
     to. See auditon(2) for details.

     LLeeggaaccyyTTiimmeerrss <<bboooolleeaann>>
     ...
     timers. This key may have no effect if the job's _P_r_o_c_e_s_s_T_y_p_e is not set
     to Interactive.

     AAssssoocciiaatteeddBBuunnddlleeIIddeennttiiffiieerrss <<ssttrriinngg oorr aarrrraayy ooff ssttrriinnggss>>
...
DDEEPPEENNDDEENNCCIIEESS
     ...
     demand instead of immediately.  llaauunncchhdd will continue to place as many
     restrictions on jobs that do not conform to this model as possible.

EEXXAAMMPPLLEE XXMMLL PPRROOPPEERRTTYY LLIISSTTSS
...
FFIILLEESS
     ...
     _/_L_i_b_r_a_r_y_/_L_a_u_n_c_h_D_a_e_m_o_n_s         System-wide daemons provided by the
                                    administrator.
     _/_S_y_s_t_e_m_/_L_i_b_r_a_r_y_/_L_a_u_n_c_h_A_g_e_n_t_s   Per-user agents provided by OS X.
     _/_S_y_s_t_e_m_/_L_i_b_r_a_r_y_/_L_a_u_n_c_h_D_a_e_m_o_n_s  System-wide daemons provided by OS X.
