...
NNAAMMEE
     ccooddeessiiggnn – Create and manipulate code signatures

SSYYNNOOPPSSIISS
     ccooddeessiiggnn _-_s _i_d_e_n_t_i_t_y [-i identifier] [-r requirements] [--ffvv] _p_a_t_h _._._.
     ccooddeessiiggnn _-_v [-R requirement] [--vv] [_p_a_t_h_|_p_i_d _._._.]
     ccooddeessiiggnn _-_d [--vv] [_p_a_t_h_|_p_i_d _._._.]
     ccooddeessiiggnn _-_h [--vv] [_p_i_d _._._.]
     ccooddeessiiggnn _-_-_v_a_l_i_d_a_t_e_-_c_o_n_s_t_r_a_i_n_t _p_a_t_h _._._.

DDEESSCCRRIIPPTTIIOONN
     The ccooddeessiiggnn command is used to create, check, and display code
     signatures, as well as inquire into the dynamic status of signed code in
     the system.

     ccooddeessiiggnn requires exactly one _o_p_e_r_a_t_i_o_n option to determine what action
     ...
     ccooddeessiiggnn accepts single-character (classic) options, as well as GNU-style
...
OOPPTTIIOONNSS
     ...
     ----aallll--aarrcchhiitteeccttuurreess
     ...
     --aa,, ----aarrcchhiitteeccttuurree _a_r_c_h_i_t_e_c_t_u_r_e
             When verifying or displaying signatures, explicitly select the
             Mach-O architecture given. The _a_r_c_h_i_t_e_c_t_u_r_e can be specified
             ...
             types.  If the _p_a_t_h uses the Mach-O format and contains no code
             ...
             ccooddeessiiggnn will always sign all architectures contained in a
             universal Mach-O file.

     ----bbuunnddllee--vveerrssiioonn _v_e_r_s_i_o_n_-_s_t_r_i_n_g
             ...
             ccooddeessiiggnn uses the bundle's default version.  Note that most
     ...
     ----cchheecckk--nnoottaarriizzaattiioonn
     ...
     --DD,, ----ddeettaacchheedd _f_i_l_e_n_a_m_e
     ...
     ----ddeeeepp  ((DDEEPPRREECCAATTEEDD ffoorr ssiiggnniinngg aass ooff mmaaccOOSS 1133..00)) When signing a bundle,
             ...
             ••   _N_e_s_t_e_d _c_o_d_e _c_o_n_t_e_n_t is a special term that only applies to
                 macOS style bundles with a Contents folder. Only bare Mach-Os
                 and well structured bundles qualify as _n_e_s_t_e_d _c_o_d_e _c_o_n_t_e_n_t_.
                 Non-bundle directories in _n_e_s_t_e_d _c_o_d_e _c_o_n_t_e_n_t locations will
                 cause an error when signing. The ccooddeessiiggnn tool will only
                 discover _n_e_s_t_e_d _c_o_d_e _c_o_n_t_e_n_t in the following directories:
             ...
             ••   If any code (Mach-Os, bundles) are located outside the above
                 listed locations they will not be signed by the ----ddeeeepp option

             ••   Using the ----ddeeeepp option on an iOS style bundle without a
             ...
             ccooddeessiiggnn command.

     ----ddeettaacchheedd--ddaattaabbaassee
     ...
     --ff,, ----ffoorrccee
             When signing, causes ccooddeessiiggnn to replace any existing signature
             on the path(s) given. Without this option, existing signatures
             will not be replaced, and the signing operation fails.

     ----ffoorrccee--lliibbrraarryy--eennttiittlleemmeennttss
     ...
     ----ggeenneerraattee--eennttiittlleemmeenntt--ddeerr
     ...
     --ii,, ----iiddeennttiiffiieerr _i_d_e_n_t_i_f_i_e_r
             ...
             possibly modified by the --prefix option.  It is a vveerryy bbaadd iiddeeaa
             to sign different programs with the same identifier.

     --oo,, ----ooppttiioonnss _f_l_a_g_,_._._.
     ...
     --PP,, ----ppaaggeessiizzee _p_a_g_e_s_i_z_e
     ...
     ----rreemmoovvee--ssiiggnnaattuurree
             Removes the current code signature from the path(s) given.

     --rr,, ----rreeqquuiirreemmeennttss _r_e_q_u_i_r_e_m_e_n_t_s
     ...
     --RR,, ----tteesstt--rreeqquuiirreemmeenntt _r_e_q_u_i_r_e_m_e_n_t
     ...
     --ss,, ----ssiiggnn _i_d_e_n_t_i_t_y
     ...
     ----ccoonnttiinnuuee
             Instructs ccooddeessiiggnn to continue processing path arguments even if
     ...
     ----eennttiittlleemmeennttss _p_a_t_h
             When signing, take the file at the given _p_a_t_h and embed its
             contents in the signature as entitlement data. If the data at
             _p_a_t_h does not already begin with a suitable binary ("blob")
             header, one is attached automatically.
             When displaying a signature, extract any entitlement data from
             the signature and write it to the _p_a_t_h given in an abstract
             representation. If needed ----xxmmll or ----ddeerr may be passed in to
     ...
     ----eennffoorrccee--ccoonnssttrraaiinntt--vvaalliiddiittyy
             When signing, require that any supplied constraints (e.g.
             ----llaauunncchh--ccoonnssttrraaiinntt--** or ----lliibbrraarryy--ccoonnssttrraaiinntt ) are structurally
             valid and contain only keys that are known on this version of
             macOS or properly use the _$_o_p_t_i_o_n_a_l operator. By default,
     ...
     ----eexxttrraacctt--cceerrttiiffiiccaatteess _p_r_e_f_i_x
             When displaying a signature, extract the certificates in the
             embedded certificate chain and write them to individual files.
             The _p_r_e_f_i_x argument is appended with numbers 0, 1, ... to form
             ...
             ASN.1 (DER) form.  If _p_r_e_f_i_x is omitted, the default prefix is
             "codesign" in the current directory.

     ----ffiillee--lliisstt _p_a_t_h
             When signing or displaying a signature, ccooddeessiiggnn writes to the
     ...
     ----iiggnnoorree--rreessoouurrcceess
     ...
     ----kkeeyycchhaaiinn _f_i_l_e_n_a_m_e
             ...
             Note that _f_i_l_e_n_a_m_e will not be searched to resolve the signing
     ...
     ----pprreesseerrvvee--mmeettaaddaattaa==lliisstt
             ...
             signing process.
             NNoottee: if the _l_i_n_k_e_r_-_s_i_g_n_e_d flag is present on the previous
     ...
     ----ssttrriicctt _o_p_t_i_o_n_s
     ...
     ----ttiimmeessttaammpp [_=_U_R_L]
             During signing, requests that a _t_i_m_e_s_t_a_m_p _a_u_t_h_o_r_i_t_y _s_e_r_v_e_r be
             contacted to authenticate the time of signing. The server
             contacted is given by the _U_R_L value.  If this option is given
             ...
             or refuses service, the signing operation will ffaaiill.
             ...
             The special value _n_o_n_e explicitly disables the use of timestamp
             services.

     ----rruunnttiimmee--vveerrssiioonn _v_e_r_s_i_o_n
             During signing, when the _r_u_n_t_i_m_e OPTION FLAG is set, explicitly
             specify the hardened runtime version stored in the code
             signature.  If this option is omitted, but the _r_u_n_t_i_m_e OPTION
     ...
     ----llaauunncchh--ccoonnssttrraaiinntt--sseellff _p_a_t_h
     ...
     ----llaauunncchh--ccoonnssttrraaiinntt--ppaarreenntt _p_a_t_h
             When signing, take the file at the given path and embed its
             contents in the signature as a launch constraint on this
     ...
     ----llaauunncchh--ccoonnssttrraaiinntt--rreessppoonnssiibbllee _p_a_t_h
             When signing, take the file at the given path and embed its
             contents in the signature as a launch constraint on this
     ...
     ----lliibbrraarryy--ccoonnssttrraaiinntt _p_a_t_h
             When signing, take the file at the given path and embed its
     ...
     ----ssttrriipp--ddiissaalllloowweedd--xxaattttrrss
     ...
     ----ssiinnggllee--tthhrreeaaddeedd--ssiiggnniinngg
             When signing, use one thread for building the resource seal.

     ----vvaalliiddaattee--ccoonnssttrraaiinntt
             Validate that the constraint plist(s) indicated by _p_a_t_h_(_s_) are
             structurally valid and contain only keys known on this OS version
             or keys that are properly wrapped with the _$_o_p_t_i_o_n_a_l operator.
             An error message is printed if an error occurs.

OOPPEERRAATTIIOONN
     In the first synopsis form, ccooddeessiiggnn attempts to sign the code objects at
     the _p_a_t_h_(_s_) given, using the _i_d_e_n_t_i_t_y provided. Internal _r_e_q_u_i_r_e_m_e_n_t_s and
     _e_n_t_i_t_l_e_m_e_n_t_s are embedded if requested. Internal requirements not
     specified may be assigned suitable default values. Defaulting applies
     separately to each type of internal requirement.  If an _i_d_e_n_t_i_f_i_e_r is
     explicitly given, it is sealed into all _p_a_t_h_(_s_).  Otherwise, each path
     derives its _i_d_e_n_t_i_f_i_e_r independently from its Info.plist or pathname.
     Code nested within bundle directories must already be signed or the
     signing operation will _f_a_i_l, unless the ----ddeeeepp option is given, in which
     case any unsigned nested code will be recursively signed before
     proceeding, using the same signing options and parameters. If the ----ffoorrccee
     option is given, any existing top-level signature is replaced, subject to
     any ----pprreesseerrvvee--mmeettaaddaattaa options also present. Combining the ----ffoorrccee and
     ----ddeeeepp options results in forcible replacement of all signatures within
     the target bundle.

     In the second synopsis form, ccooddeessiiggnn verifies the code signatures on all
     the _p_a_t_h_(_s_) given. The verification confirms that the code at those
     _p_a_t_h_(_s_) is signed, that the signature is valid, and that all sealed
     components are unaltered. Valid in this case means that the signature is
     structurally and cryptographically sound. If a _r_e_q_u_i_r_e_m_e_n_t is given, each
     _p_a_t_h is also checked against this requirement (but see DIAGNOSTICS
     ...
     If a _p_a_t_h begins with a decimal digit, it is interpreted as the process
     ...
     In the third synopsis form, ccooddeessiiggnn displays the contents of the
     signatures on the _p_a_t_h_(_s_) given. More information is displayed as the
     verbosity level increases.  This form may not completely verify the
     signatures on the _p_a_t_h_(_s_); though it may perform some verification steps
     in the process of obtaining information about the _p_a_t_h_(_s_).  If the _-_r
     _p_a_t_h option is given, internal requirements will be extracted from the
     _p_a_t_h_(_s_) and written to _p_a_t_h; specify a dash "-" to write to standard
     ...
     If the _-_-_e_n_t_i_t_l_e_m_e_n_t_s _p_a_t_h option is given, embedded entitlement data
     will be extracted likewise and written to the file specified.

     In the fourth synopsis form, ccooddeessiiggnn constructs the hosting path for
     each _p_i_d given and writes it, one host per line, to standard output. The
     ...
     kernel). If the _-_-_v_e_r_b_o_s_e option is given, the dynamic validity status of
     ...
     unsigned code, and the output of this form of the ccooddeessiiggnn command should
     not be taken as a statement of formal code validity. Only ccooddeessiiggnn
     _-_-_v_e_r_i_f_y can do that; and in fact, formal verification constructs the
     hosting chain as part of its operation (but does not display it).

     In the fifth synopsis form, ccooddeessiiggnn validates the _p_a_t_h_(_s_) supplied.
     ...
     nested in the _$_o_p_t_i_o_n_a_l operator.

SSIIGGNNIINNGG IIDDEENNTTIITTIIEESS
     ...
     If the _-_-_k_e_y_c_h_a_i_n argument is used, _i_d_e_n_t_i_t_y is only looked-for in the
     ...
     The _i_d_e_n_t_i_t_y is first considered as the full name of a kkeeyycchhaaiinn iiddeennttiittyy
     pprreeffeerreennccee.  If such a preference exists, it directly names the identity
     used.  Otherwise, the identity is located by searching all keychains for
     a certificate whose subject ccoommmmoonn nnaammee (only) contains the _i_d_e_n_t_i_t_y
     ...
     If _i_d_e_n_t_i_t_y consists of exactly forty hexadecimal digits, it is instead
     ...
     Both iiddeennttiittyy pprreeffeerreenncceess and certificate hashes can be used to identify
     a particular signing identity regardless of name. Identity preferences
     are global settings _f_o_r _e_a_c_h _u_s_e_r and provide a layer of indirection.
     ...
     If _i_d_e_n_t_i_t_y is the single letter "-" (dash), aadd--hhoocc ssiiggnniinngg is performed.
     ...
     ccooddeessiiggnn will attempt to embed the entire certificate chain documenting
     ...
     independent source for the missing certificates (from _i_t_s keychains).

SSPPEECCIIFFYYIINNGG RREEQQUUIIRREEMMEENNTTSS
     The _r_e_q_u_i_r_e_m_e_n_t_(_s_) arguments (-r and -R) can be given in various forms. A
     plain text argument is taken to be a path to a file containing the
     requirement(s).  ccooddeessiiggnn will accept both binary files containing
...
OOPPTTIIOONN FFLLAAGGSS
     ...
     are recognized by ccooddeessiiggnn; other flags may exist at the API level. Note
     ...
     linker-signed
              ...
              ••   linker signatures can be replaced without using the _-_-_f_o_r_c_e
                  option.

              ••   linker signatures are never preserved regardless of the use
                  of the _-_-_p_r_e_s_e_r_v_e_-_m_e_t_a_d_a_t_a option.
...
TTRROOUUBBLLEESSHHOOOOTTIINNGG
     A common source of confusion when using ccooddeessiiggnn arises from the ordering
     of command line options. If ccooddeessiiggnn is not behaving as expected, consult
     this manual and check the ordering of your arguments. As a general rule
     ccooddeessiiggnn follows a vveerrbb nnoouunn rule. For example ----ssiiggnn should be placed
     before ----ooppttiioonnss in the invocation. This is because you are performing a
     "sign" action with a given set of options.

     If these are inverted and ----ooppttiioonnss is provided before ----ssiiggnn in the
     invocation, the value of ----ooppttiioonnss is ignored silently.

DDIIAAGGNNOOSSTTIICCSS
     ccooddeessiiggnn exits 0 if all operations succeed. This indicates that all codes
     ...
     failed to satisfy the requirement specified with the _-_R option.
     ...
     unless the --continue option was specified, in which case ccooddeessiiggnn will
     defer the failure exit until after it has attempted to process all path
     arguments in turn.

SSIIGGNNIINNGG AATTOOMMIICCIITTYY
     ...
     If you require atomicity of signing stricter than provided by ccooddeessiiggnn,
...
FFIILLEESS
     _/_v_a_r_/_d_b_/_D_e_t_a_c_h_e_d_S_i_g_n_a_t_u_r_e_s  System-wide database of detached code
...
HHIISSTTOORRYY
     The ccooddeessiiggnn command first appeared in Mac OS 10.5.0 (Leopard).

BBUUGGSS
     Some options only apply to particular operations, and ccooddeessiiggnn ignores
     ...
     The dual meaning of the _-_v option, indicating either verbosity or
     verification, confuses some people. If you find it confusing, use the
     unambiguous long forms _-_-_v_e_r_b_o_s_e and _-_-_v_e_r_i_f_y instead.

     The ----vveerriiffyy option can take either a file or a pid. If your file path
     starts with a number you should prefix it with "./" to force ccooddeessiiggnn to
...
NNOOTTEESS
     The Xcode build system invokes ccooddeessiiggnn automatically if the
     CODE_SIGN_IDENTITY build variable is set.  You can express any
     combination of ccooddeessiiggnn options with additional build variables there.

     ccooddeessiiggnn is fundamentally a shell around the code signing APIs, and
     performs nothing of the underlying work.  Replacing it with older or
     newer versions is unlikely to have a useful effect.

     ccooddeessiiggnn has several operations and options that are purposely left
...
macOS 26.3                        May 7, 2011                       macOS 26.3
