...
- Source: https://developers.openai.com/api/docs/llms.txt
- HTTP status: 200
...
- [Prompt guidance](https://developers.openai.com/api/docs/guides/prompt-guidance.md)
...
- [Using GPT-5.5](https://developers.openai.com/api/docs/guides/latest-model.md): Learn how to use and migrate to GPT-5.5, the latest model in the OpenAI API.
